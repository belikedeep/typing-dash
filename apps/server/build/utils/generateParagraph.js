...
exports.generateParagraphUsingLoremIpsum = generateParagraphUsingLoremIpsum;
function generateParagraph() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch("http://metaphorpsum.com/paragraphs/10");
            if (!response.ok) {
                throw new Error();
            }
